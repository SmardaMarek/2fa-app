                ...
                <div class="p-8 md:p-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/50 shadow-inner group hover:border-emerald-500/30 transition-colors">
                            ...
                            <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                                Pokud se požadované <code>rpId</code> (identifikátor služby, pro kterou byl klíč vytvořen) neshoduje s aktuální doménou webu (Origin), prohlížeč odmítne komunikovat s autentizátorem. Útočník tak nedostane šanci vylákat z klíče podpis.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-slate-800/40 dark:backdrop-blur-md overflow-hidden shadow-xl dark:shadow-2xl sm:rounded-3xl border border-gray-200 dark:border-slate-700/50 flex flex-col transition-all duration-300">
                ...
                <div class="p-8 md:p-10 border-b border-gray-100 dark:border-slate-700/50">
                    <div class="prose dark:prose-invert prose-indigo max-w-none text-gray-600 dark:text-slate-300 mb-8 leading-relaxed">
                        <p>
                            FIDO2 / WebAuthn nestojí na porovnávání řetězců jako hesla, ale na digitálním podpisu. Během ověření provede autentizátor asymetrickou operaci, při které svým <strong>privátním klíčem</strong> podepíše serverem vygenerovanou výzvu (Challenge) spolu s identifikátorem domény (Origin).
                        </p>
                    </div>
                ...
                <div class="p-8 md:p-10 border-t border-gray-100 dark:border-slate-700/50">
                    ...
                    <div class="prose dark:prose-invert prose-indigo max-w-none text-gray-600 dark:text-slate-300 mb-6 leading-relaxed">
                        <p>
                            FIDO2 poskytuje nejvyšší úroveň ochrany (AAL3), ale <strong>žádný systém není absolutně neprůstřelný</strong>. Jak jste viděli v sandboxu, je nutné znát zbytková rizika a mít plán pro jejich eliminaci:
                        </p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <table class="w-full text-xs font-mono">
                            ...
                            <tbody class="text-slate-300">
                                <tr class="border-b border-slate-800">
                                    <td class="py-3 px-4 text-slate-400">Origin Binding</td>
                                    <td class="py-3 px-4 text-center text-rose-400 font-bold">✗</td>
                                    <td class="py-3 px-4 text-center text-rose-400 font-bold">✗</td>
                                    <td class="py-3 px-4 text-center text-amber-400 font-bold">≈ (přes FIDO2)</td>
                                ...
                                <tr class="border-b border-slate-800">
                                    ...
                                    <td class="py-3 px-4 text-center text-slate-500">Mobilní telefon</td>
                                    <td class="py-3 px-4 text-center text-slate-500">Smartphone / PC</td>
                                    <td class="py-3 px-4 text-center text-slate-500">Biometrický snímač</td>
                                    <td class="py-3 px-4 text-center text-slate-500">Bezp. klíč / TPM</td>
                                </tr>
                                <tr class="border-b border-slate-800">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-center text-rose-400">SIM Swap, SS7</td>
                                    <td class="py-3 px-4 text-center text-rose-400">AitM Phishing</td>
                                    <td class="py-3 px-4 text-center text-rose-400">Spoofing, neodvolatelnost</td>
                                    <td class="py-3 px-4 text-center text-amber-400">Ztráta zařízení</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
