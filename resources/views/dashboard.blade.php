                ...
                @foreach ($modules as $module)
                    ...
                    <div class="relative group bg-slate-800/40 backdrop-blur-md overflow-hidden rounded-2xl border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 flex flex-col shadow-xl hover:shadow-indigo-500/10">
                        ...
                        <div class="px-6 md:px-8 pb-6 md:pb-8 mt-auto">
                            ...
                            @if($isCompleted)
                                <a href="{{ route('module.guide', ['module' => $module->slug]) }}" class="mt-3 w-full inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold text-amber-500 hover:text-amber-400 uppercase tracking-widest transition-colors group/guide">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                                    Nastavte si to doma
                                    <svg class="w-3 h-3 group-hover/guide:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                                </a>
                            @endif
                        </div>
                    </div>
